...
class DeckCollectionTestCase(AuthenticatedAPITestCase):
    ...
    def test_create_deck(self):
        ...
        self.assertEqual(body['cards_remaining'], 52)
        self.assertEqual(body['cards_removed'], 0)
    ...
    #     self.assertEqual(body[0]['cards_remaining'], 52)
    #     self.assertEqual(body[0]['cards_removed'], 0)
